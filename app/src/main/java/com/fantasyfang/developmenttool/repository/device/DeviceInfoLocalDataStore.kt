...
class DeviceInfoLocalDataStore @Inject constructor() : LocalDataStore<List<DeviceInfo>> {
    ...
    override suspend fun getData(): LiveData<List<DeviceInfo>> {
        ...
        return liveData {
            emit(
                listOf(
                    ...
                    DeviceInfo(
                        Item(
                            DeviceItem.SUPPORTED_32_BIT_ABIS,
                            Result.Success(support32ABI)
                        )
                    ),
                    DeviceInfo(
                        Item(
                            DeviceItem.SUPPORTED_64_BIT_ABIS,
                            Result.Success(support64ABI)
                        )
                    ),
                    DeviceInfo(
                        Item(
