...
class ScreenInfoLocalDataStore @Inject constructor(private val context: Context) :
    ...
    override suspend fun getData(): LiveData<List<ScreenInfo>> {
        ...
        return liveData {
            emit(
                listOf(
                    ...
                    ScreenInfo(
                        Item(
                            ScreenItem.DENSITY_DPI,
                            Result.Success(metrics.densityDpi.toString())
                        )
                    ),
                    ScreenInfo(
                        Item(
                    ...
                    ScreenInfo(
                        Item(
                            ScreenItem.WIDTH_DP,
                            Result.Success(metricsScreen.getWidthDP().toString())
                        )
                    ),
                    ScreenInfo(
                        Item(
                            ScreenItem.HEIGHT_DP,
                            Result.Success(metricsScreen.getHeightDP().toString())
                        )
                    ),
                    ScreenInfo(
                        Item(
